            ...
            <div className="lgx-inner">
                <div className="container">
                    <div className="row">
                        <div className="col-xs-12">
                            <div className="lgx-heading">
                                <h2 className="heading">From Our Blog</h2>
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-sm-6 col-md-4">
                            <div className="lgx-single-news">
                                <figure>
                                    <a href="news-single.html"><img src="http://placehold.it/1144x690" alt=""></img></a>
                                </figure>
                                <div className="single-news-info">
                                    ...
                                    <h3 className="title"><a href="news-single.html">Brooklyn Beta was the most important conferen best tristique</a></h3>
                                    <a className="lgx-btn lgx-btn-white lgx-btn-sm" href="#"><span>Read More</span></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div className="section-btn-area">
                        <a className="lgx-btn" href="news.html">View More Blogs</a>
                    </div>
                </div>
            </div>
        </div>
